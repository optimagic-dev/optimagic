...
def plot_derivative_free_direct_search(textstr, save_path):
    path = 'docs/source/_static/images/intermediate_result/derivative_free_direct_search'
    ...
    for i in range(5):
        ...
        # save frame
        plt.figtext(0.5, -0.01, textstr[i] ,multialignment='center', ha="center", wrap=True, fontsize=18, bbox={"facecolor":"white", "alpha":0.5, "pad":5})
...
@pytask.mark.produces(BLD/"images"/"final_result"/"derivative_free_direct_search_algorithm.gif")
