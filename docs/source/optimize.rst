...
Constraints that are implemented by lower and upper bounds as well as reparametrizations
(also called kernel transformations) are typically very efficient and can be applied
independent of the optimization routine used.

The drawback is that they are cumbersome to implement by hand and are less generally
