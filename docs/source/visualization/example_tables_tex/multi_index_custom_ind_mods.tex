...
&&\multicolumn{3}{r}\textit{This is the first note of some length} \\
&&\multicolumn{3}{r}\textit{This is the second note probably of larger length} \\
\bottomrule
\end{tabular}
