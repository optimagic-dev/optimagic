...
solution_x_bratu_2d_t = np.array(
    [
        0.1933024,
        0.33566336,
        0.43355494,
...
solution_x_cbratu_2d = np.concatenate([solution_x_cbratu_2d, np.zeros(25)])

solution_x_broydn_bd = np.array(
    [
        -0.00000000e00,
        -0.00000000e00,
        -0.00000000e00,
...
solution_x_yatpsq_1 = np.array(
    [7.06817436] * 100 + [4011.71977601] * 10 + [-4045.83698215] * 10
)
solution_x_yatpsq_2 = np.array(
    [0.0500104219] * 100 + [31.74567612] * 10 + [-32.22096803] * 10
)
solution_x_arglble = np.array(
    [
        1.47780425,
        1.95560851,
        3.92938553,
...
CARTIS_ROBERTS_PROBLEMS = {
    ...
    "hatfldg": {
        "criterion": hatfldg,
        "start_x": np.ones(25),
        "solution_x": np.array([0] * 11 + [-1, 1] + [0] * 12),
        "start_criterion": 27,
        "solution_criterion": 0,
    },
    "integreq": {
    ...
    "arglale": {
        ...
        "start_x": np.ones(100),
        "solution_x": -0.99999952 * np.ones(100),
        "start_criterion": 700,
