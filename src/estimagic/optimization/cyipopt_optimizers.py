    ...
    *,
    ...
    Args:
        ...
        stopping.max_cpu_time (float): Maximum number of CPU seconds.
            ...
            real option is 0 < max_cpu_time and its default value is 1e20.
        ...
        constr_viol_tol (float): Desired threshold for the constraint and bound
            ...
            If option bound_relax_factor is not
            zero 0, then Ipopt relaxes given variable bounds. The value of
            constr_viol_tol is used to restrict the absolute amount of this bound
            relaxation. The valid range for this real option is
            0 < constr_viol_tol
        ...
        compl_inf_tol (float): Desired threshold for the complementarity conditions.
            ...
            0 < compl_inf_tol and its default is 0.0001.
        ...
        acceptable_tol (float):"Acceptable" convergence tolerance (relative).
            Determines which
            (scaled) overall optimality error is considered to be "acceptable". The
            valid range for this real option is 0 < acceptable_tol.
        ...
        acceptable_obj_change_tol (float): "Acceptance" stopping criterion based on
            ...
            change of the objective function (scaled by Max(1,|f(x)|)) is less than
        ...
        nlp_scaling_max_gradient (float): Maximum gradient after NLP scaling.
            ...
            nlp_scaling_max_gradient and its default value is 100.
        ...
        least_square_init_duals (str or bool): Least square
            ...
            this string option is "no". Possible values:
                - "no": use bound_mult_init_val and least-square equality
        ...
        warm_start_mult_init_max (float): Maximum initial value for the
            ...
            unrestricted and its default value is 10+06. warm_start_entire_iterate
            (str or bool): Tells algorithm whether to use the GetWarmStartIterate
        ...
        mu_min (float): Minimum value for barrier parameter. This option
            ...
            selection mode. By default, it is set to the minimum of 1e-11 and
        ...
        mu_oracle (str): Oracle for a new barrier parameter in the adaptive strategy.
            Determines how a new
            barrier parameter is computed in each "free-mode" iteration of the
        ...
        mu_init (float): Initial value for the barrier parameter. This option
            ...
            range for this real option is 0 < mu_init and its default value is
            0.1.
        ...
        sigma_min (float): Advanced
            ...
            "quality-function". The valid range for this real option is 0 ≤
            sigma_min and its default value is 10-06.
        ...
        accept_after_max_steps (float): advanced feature.
            ...
            integer option is -1 ≤ accept_after_max_steps and its default value is
            -1.
        ...
        tiny_step_tol (float): Advanced feature. Tolerance for detecting
            ...
            its default value is 2.22045 · 10-15.
        ...
        slack_move (float): advanced! Correction
            ...
            default value is 1.81899 · 10-12.
