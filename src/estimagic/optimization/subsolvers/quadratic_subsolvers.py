...
# ======================================================================================
# Subsolver GQTPAR FAST
# ======================================================================================


def minimize_gqtpar_quadratic_fast(model, *, k_easy=0.1, k_hard=0.2, maxiter=200):
    """Solve the quadratic trust-region subproblem via nearly exact iterative method.
...
def _minimize_gqtpar(model_gradient, model_hessian, k_easy, k_hard, maxiter):
    ...
    for _niter in range(maxiter):
        ...
        if hessian_already_factorized is True:
            hessian_already_factorized = False
        else:
            (
                hessian_plus_lambda,
                ...
                factorization_info,
            ) = add_lambda_and_factorize_hessian_fast(model_hessian, lambda_candidate)
    ...
    f_min = evaluate_model_criterion(x_candidate, model_gradient, model_hessian)
    return x_candidate, f_min, _niter, converged
