...
def create_performance_df(problems, results):
    ...
    # for this _calculate_share_of_improvement_missing must be rewritten.
    # This is also advisable because that function is very slow.
...
def clip_histories(df, stopping_criterion, x_precision, y_precision):
    ...
    """
    ### Call this again as part of create_performance_df
...
def _determine_alpha_grid(performance_ratios):
    ...
    """
    ### Add some points between switching points
...
def _calculate_share_of_improvement_missing(sr, start_values, target_values):
    ...
    """
    ### This is the bottleneck runtimewise (70%).
    ### Rewrite to not expect a MultiIndex and do not use unstack.
    ### this also needs a direction argument.
