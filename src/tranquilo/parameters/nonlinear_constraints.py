...
from tranquilo.exceptions import InvalidConstraintError, InvalidFunctionError
from tranquilo.optimization.algo_options import CONSTRAINTS_ABSOLUTE_TOLERANCE
from tranquilo.parameters.block_trees import block_tree_to_matrix
