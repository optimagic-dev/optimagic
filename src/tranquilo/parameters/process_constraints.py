...
from tranquilo.parameters.check_constraints import (
    check_constraints_are_satisfied,
    check_fixes_and_bounds,
    check_for_incompatible_overlaps,
    check_types,
)
from tranquilo.parameters.consolidate_constraints import consolidate_constraints
from tranquilo.utilities import number_of_triangular_elements_to_dimension
