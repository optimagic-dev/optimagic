...
from tranquilo.benchmarking.cartis_roberts import CARTIS_ROBERTS_PROBLEMS
from tranquilo.benchmarking.more_wild import MORE_WILD_PROBLEMS
from tranquilo.benchmarking.noise_distributions import NOISE_DISTRIBUTIONS
