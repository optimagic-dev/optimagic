...
orig_data = pd.read_csv(
    r"C:\Users\Jrxz12\estimagic-master\estimagic\inference\src\examples\data.csv"
)
orig_data["fpc"] = 0.8
...
# =============================================================================
params_df, cov = likelihood_inference(log_like_kwargs, design_dict=None, cov_type="opg")
